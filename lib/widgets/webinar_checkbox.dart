...
class WebinarUICheckBox extends StatefulWidget {
  final bool value;
  ...
  @override
  WebinarUICheckBoxState createState() => WebinarUICheckBoxState();
}

class WebinarUICheckBoxState extends State<WebinarUICheckBox> {
  late bool _checked;
  ...
  @override
  void didUpdateWidget(covariant WebinarUICheckBox oldWidget) {
